...
#define OS_MAX_EVENTS            35u   /* Max. number of event control blocks in your application      */
...
#define OS_MAX_TASKS             22u   /* Max. number of tasks in your application, MUST be >= 2       */
